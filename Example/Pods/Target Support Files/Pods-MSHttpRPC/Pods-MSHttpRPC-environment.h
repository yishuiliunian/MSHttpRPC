...
// MSHttpRPC
#define COCOAPODS_POD_AVAILABLE_MSHttpRPC
#define COCOAPODS_VERSION_MAJOR_MSHttpRPC 0
#define COCOAPODS_VERSION_MINOR_MSHttpRPC 1
#define COCOAPODS_VERSION_PATCH_MSHttpRPC 0
